...
A continuación se procede a cargar la base de datos extraída desde https://www.kaggle.com/datatattle/covid-19-nlp-text-classification?select=Corona_NLP_test.csv y https://www.kaggle.com/datatattle/covid-19-nlp-text-classification?select=Corona_NLP_train.csv para poder realizar el análisis respectivo.
