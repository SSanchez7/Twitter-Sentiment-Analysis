...
•	Se extraerá características del texto de los tweets representándolo de forma vectorial para relacionarlo con el sentimiento que se le ha asignado de forma manual, esto se realizó en parte en el Hito 1, pero para el Hito 3 se trabajará de forma más sofisticada.

•	Se dividirá la base de datos en dos grupo set de entrenamiento y set de evaluación, con un porcentaje de 70% y 30% respectivamente .
...
•	Después de elegir el modelo que mejor clasifica los datos a partir de las métricas mencionadas, se usará este modelo para asignar sentimiento a una base de datos nueva que será limpiada y estandarizada según los atributos de la base de datos inicial.
