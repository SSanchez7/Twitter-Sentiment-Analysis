...
•	Para definir el modelo que arroja una mejor clasificación se evaluará la base de datos usando Naive Bayes, Arboles de desicion, K_Mean y SVM, en donde se utilizan las columnas por palabras creadas anteriormente para poder predecir un sentimiento. Se asignaran hiperparámetros de evaluación a cada uno de los modelos a usar utilizando técnicas como GridS.
